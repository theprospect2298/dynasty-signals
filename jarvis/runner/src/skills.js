...
function buildSystemPrompt(claudeMd) {
  return [
    ...
    '',
    'Your configuration (CLAUDE.md) is included in full below — you do not need',
    'to read it from disk. If you ever must re-read it, its canonical path is',
    '07-SYSTEM/CLAUDE.md (there is no CLAUDE.md at the vault root).',
    '',
